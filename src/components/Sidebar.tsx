        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-slate-800 border border-slate-700 text-sm rounded-md px-3 py-2.5 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-100"
            >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] bg-blue-900/50 text-blue-300 px-2 py-0.5 rounded-full font-medium">
              {agencies.filter(a => a.checked).length} selected
            </span>
          </div>
